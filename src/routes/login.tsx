      ...
      <div className="min-h-dvh px-6 pb-10 pt-10">
        ...
        <div className="mt-8">
          ...
          <p className="mt-2 text-sm text-[#8A8A8A]">
            Log in to manage your electrical service appointments.
          </p>
        </div>
        ...
        >
          ...
          <div>
            ...
            <div className="mt-2 text-right">
              <Link
                to="/forgot-password"
                className="text-xs font-semibold text-[#FFC107]"
              >
                Forgot Password?
              </Link>
            </div>
        ...
        <p className="mt-8 text-center text-xs text-[#8A8A8A]">
          ...
          <Link to="/register" className="font-bold text-[#FFC107]">
            Sign Up
          </Link>
        </p>
      </div>
...
function GoogleIcon() {
  return (
    <svg width="16" height="16" viewBox="0 0 48 48" aria-hidden>
      <path fill="#FFC107" d="M43.6 20.5H42V20H24v8h11.3C33.6 32.9 29.2 36 24 36c-6.6 0-12-5.4-12-12s5.4-12 12-12c3 0 5.8 1.1 7.9 3l5.7-5.7C33.9 6 29.2 4 24 4 12.9 4 4 12.9 4 24s8.9 20 20 20 20-8.9 20-20c0-1.2-.1-2.3-.4-3.5z"/>
      <path fill="#FF3D00" d="M6.3 14.7l6.6 4.8C14.6 15.5 18.9 12 24 12c3 0 5.8 1.1 7.9 3l5.7-5.7C33.9 6 29.2 4 24 4 16.3 4 9.7 8.3 6.3 14.7z"/>
      <path fill="#4CAF50" d="M24 44c5.1 0 9.7-1.9 13.2-5l-6.1-5c-2 1.4-4.5 2.2-7.1 2.2-5.1 0-9.5-3.1-11.3-7.5l-6.5 5C9.5 39.6 16.2 44 24 44z"/>
      <path fill="#1976D2" d="M43.6 20.5H42V20H24v8h11.3c-.9 2.5-2.5 4.6-4.6 6l6.1 5C41 35.9 44 30.4 44 24c0-1.2-.1-2.3-.4-3.5z"/>
    </svg>
  );
}
function AppleIcon() {
